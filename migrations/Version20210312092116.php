 ...
 */
final class Version20210312092116 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE permissions_users (permissions_id INT NOT NULL, users_id INT NOT NULL, INDEX IDX_5F7CBD769C3E4F87 (permissions_id), INDEX IDX_5F7CBD7667B3B43D (users_id), PRIMARY KEY(permissions_id, users_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE permissions_users ADD CONSTRAINT FK_5F7CBD769C3E4F87 FOREIGN KEY (permissions_id) REFERENCES permissions (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE permissions_users ADD CONSTRAINT FK_5F7CBD7667B3B43D FOREIGN KEY (users_id) REFERENCES users (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE permissions_users DROP FOREIGN KEY FK_5F7CBD769C3E4F87');
        $this->addSql('ALTER TABLE comments DROP FOREIGN KEY FK_5F9E962A59D8A214');
        $this->addSql('ALTER TABLE comments DROP FOREIGN KEY FK_5F9E962AF675F31B');
        $this->addSql('ALTER TABLE permissions_users DROP FOREIGN KEY FK_5F7CBD7667B3B43D');
        $this->addSql('ALTER TABLE recipes DROP FOREIGN KEY FK_A369E2B5F675F31B');
        $this->addSql('DROP TABLE categories');
        $this->addSql('DROP TABLE comments');
        $this->addSql('DROP TABLE permissions');
        $this->addSql('DROP TABLE permissions_users');
