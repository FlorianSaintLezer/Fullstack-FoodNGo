...
return [
    ...
    [ // $staticRoutes
        ...
        '/admin/comments' => [[['_route' => 'comments', '_controller' => 'App\\Controller\\AdminCommentsController::comments'], null, null, null, true, false, null]],
        '/admin/comments/creation' => [[['_route' => 'admin_comments_creation', '_controller' => 'App\\Controller\\AdminCommentsController::modification'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        199 => [
            [['_route' => 'admin_comments_modification', '_controller' => 'App\\Controller\\AdminCommentsController::modification'], ['id'], ['GET' => 0, 'POST' => 1], null, false, true, null],
            [['_route' => 'admin_comments_suppression', '_controller' => 'App\\Controller\\AdminCommentsController::suppression'], ['id'], ['DELETE' => 0], null, false, true, null],
        ],
        227 => [
            [['_route' => 'admin_recipes_modification', '_controller' => 'App\\Controller\\AdminRecipesController::modification'], ['id'], ['GET' => 0, 'POST' => 1], null, false, true, null],
            [['_route' => 'admin_recipes_suppression', '_controller' => 'App\\Controller\\AdminRecipesController::suppression'], ['id'], ['DELETE' => 0], null, false, true, null],
