 ...
 */
class getPermissionsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PermissionsRepository' shared autowired service.
     *
     * @return \App\Repository\PermissionsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PermissionsRepository.php';

        return $container->privates['App\\Repository\\PermissionsRepository'] = new \App\Repository\PermissionsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
